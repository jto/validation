...
libraryDependencies +="io.github.jto" %% "validation-core" % "1.0"

// Json validation
libraryDependencies +="io.github.jto" %% "validation-json" % "1.0"

// Form validation
libraryDependencies +="io.github.jto" %% "validation-form" % "1.0"

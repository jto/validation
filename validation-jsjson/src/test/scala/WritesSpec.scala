...
class WritesSpec extends WordSpec with Matchers with JsAnyEquality {
  ...
  "Writes" should {
    ...
    "support primitives types" when {
      ...
      "Int" in {
        ...
        (Path \ "n" \ "o" \ "p").write[Int, js.Dynamic].writes(4) shouldBe
          (js.Dynamic.literal(
            "n" -> js.Dynamic.literal("o" -> js.Dynamic.literal("p" -> 4))))
      }
      ...
      "Float" in {
        ...
        (Path \ "n" \ "o" \ "p").write[Float, js.Dynamic].writes(4.5f) shouldBe
          (js.Dynamic.literal(
            "n" -> js.Dynamic.literal("o" -> js.Dynamic.literal("p" -> 4.5))))
      }
      ...
      "Boolean" in {
        ...
        (Path \ "n" \ "o" \ "p")
          .write[Boolean, js.Dynamic]
          .writes(true) shouldBe
          (js.Dynamic.literal(
            "n" -> js.Dynamic.literal("o" -> js.Dynamic.literal("p" -> true))))
      }
      ...
      "String" in {
        ...
        (Path \ "n" \ "o" \ "p")
          .write[String, js.Dynamic]
          .writes("foo") shouldBe
          (js.Dynamic.literal(
            "n" -> js.Dynamic.literal("o" -> js.Dynamic.literal("p" -> "foo"))))
      }
      ...
      "Map[String, Seq[V]]" in {
        ...
        (Path \ "n" \ "o")
          ...
          (js.Dynamic.literal(
            "n" -> js.Dynamic.literal("o" -> js.Dynamic.literal("foo" -> 4))))
        (Path \ "n" \ "o")
          .write[Map[String, Int], js.Dynamic]
    ...
    "compose" in {
      ...
      w.writes(Some("jto@foobar.com") -> Nil) shouldBe js.Dynamic
        .literal("email" -> "jto@foobar.com", "phones" -> js.Array())

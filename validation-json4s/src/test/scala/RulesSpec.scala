  ...
  "Json Rules" should {
    ...
    "support all types of Json values" when {
      ...
      "String" in {
        ...
        (Path \ "n").read[JValue, String].validate(JObject(Map("n" -> JArray(JString("foo"))))) shouldBe(Invalid(Seq(Path \ "n" -> Seq(ValidationError("error.invalid", "String")))))
      ...
      "JObject" in {
        ...
        (Path \ "n").read[JValue, JObject].validate(JObject(Map("n" -> JArray(JString("foo"))))) shouldBe(Invalid(Seq(Path \ "n" -> Seq(ValidationError("error.invalid", "Object")))))
      }
      ...
      "Traversable" in {
        (Path \ "n").read[JValue, Traversable[String]].validate(JObject(Map("n" -> JArray(JString("foo"))))).toOption.get.toSeq shouldBe(Seq("foo"))
        (Path \ "n").read[JValue, Traversable[Int]].validate(JObject(Map("n" -> JArray(JNumber(1), JNumber(2), JNumber(3))))).toOption.get.toSeq shouldBe(Seq(1, 2, 3))
      ...
      "Array" in {
        (Path \ "n").read[JValue, Array[String]].validate(JObject(Map("n" -> JArray(JString("foo"))))).toOption.get.toSeq shouldBe(Seq("foo"))
        (Path \ "n").read[JValue, Array[Int]].validate(JObject(Map("n" -> JArray(JNumber(1), JNumber(2), JNumber(3))))).toOption.get.toSeq shouldBe(Seq(1, 2, 3))
      ...
      "Seq" in {
        (Path \ "n").read[JValue, Seq[String]].validate(JObject(Map("n" -> JArray(JString("foo"))))).toOption.get shouldBe(Seq("foo"))
        (Path \ "n").read[JValue, Seq[Int]].validate(JObject(Map("n" -> JArray(JNumber(1), JNumber(2), JNumber(3))))).toOption.get shouldBe(Seq(1, 2, 3))
        ...
        (Path \ "n").read[JValue, Seq[String]].validate(JObject(Map("n" -> JArray(JString("foo"), JNumber(2))))) shouldBe(Invalid(Seq(Path \ "n" \ 1 -> Seq(ValidationError("error.invalid", "String")))))
      }
    ...
    "lift validations to seq validations" in {
      ...
      (Path \ "n").from[JValue](seqR(notEmpty))
        .validate(JObject(Map("n" -> JArray(JString("foo"), JString(""))))) shouldBe(Invalid(Seq(Path \ "n" \ 1 -> Seq(ValidationError("error.required")))))
    }

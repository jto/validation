    ...
    "read primitive types" when {
      ...
      "java BigDecimal" in {
        Path.read[Node, jBigDecimal].validate(<a>4</a>) shouldBe Valid(
          new jBigDecimal("4"))
        attributeR[jBigDecimal]("attr")
          .validate(<a attr="4"></a>) shouldBe Valid(new jBigDecimal("4"))
      ...
      "scala BigDecimal" in {
        Path.read[Node, BigDecimal].validate(<a>4</a>) shouldBe Valid(
          BigDecimal("4"))
        attributeR[BigDecimal]("attr")
          .validate(<a attr="4"></a>) shouldBe Valid(BigDecimal("4"))
      ...
      "Boolean" in {
        ...
        attributeR[Boolean]("attr")
          .validate(<a attr="true"></a>) shouldBe Valid(true)
      ...
      "Node" in {
        (Path \ "b")
          .read[Node, Node]
          .validate(<a><b>foo</b></a>) shouldBe Valid(<b>foo</b>)
      }
      ...
      "Seq" in {
        Path
          .read[Node, Seq[String]]
          .validate(<a><b>foo</b></a>)
          .toOption
          .get shouldBe
          (Seq("foo"))
        Path
        ...
        Path.read[Node, Seq[Int]].validate(<a><b>1</b><b>foo</b></a>) shouldBe
          (Invalid(
            Seq(Path \ 1 -> Seq(ValidationError("error.number", "Int")))))
      }
      ...
      "lift validations to seq validations" in {
        ...
        Path
          .from[Node](seqR(notEmpty))
          .validate(<a><b>foo</b><b></b></a>) shouldBe
      ...
      "perform complex validation" in {
        ...
        contactValidated.validate(invalid) shouldBe
          (Invalid(
            Seq(
              (Path \ "informations") -> Seq(ValidationError("error.required")),
      ...
      "use attribute filtering" in {
        val reads = (
          pickChildsWithAttribute[String](
            "entity",
            attrKey = "type",
            attrValue = "type1")(attributeR[String]("name"))
        )
      ...
      "use attribute filtering to read first" in {
        ...
        reads.validate(entityXml) shouldBe Valid(
          ("software engineer" -> "fulltime", 25))
